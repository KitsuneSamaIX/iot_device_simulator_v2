...
def shadow_handler(endpoint, cert, key, root_ca, thing_name_param, shadow_property_param='color', client_id=str(uuid4())):
    # Using globals to simplify sample code
    global mqtt_connection, shadow_client, thing_name, shadow_property
    thing_name = thing_name_param
    shadow_property = shadow_property_param
